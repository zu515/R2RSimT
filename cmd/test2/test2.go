...
func dumpTrie(trie *Trie) string {
...
func main()  {
	...
	fmt.Println(msbMatrix[97])
	fmt.Println(msbMatrix[98])
	fmt.Println(msbMatrix[98^99])
	fmt.Println(msbMatrix[100])
