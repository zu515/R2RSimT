...
type ListPeerRequest struct {
	...
	AddressAndPort 	string   `protobuf:"bytes,3,opt,name=addressandport" json:"addressandport,omitempty"`
}
...
type ResetPeerRequest struct {
	...
	AddressAndPort  string 							  `protobuf:"bytes,5,opt,name=addressandport" json:"addressandport,omitempty"`
}
...
type ListPathRequest struct {
	...
	AddressAndPort        string 				   `protobuf:"bytes,9,opt,name=addressandport" addressandport:"name,omitempty"`
}
...
type GetTableRequest struct {
	...
	AddressAndPort      string    `protobuf:"bytes,4,opt,name=addressandport" json:"addressandport,omitempty"`
}
